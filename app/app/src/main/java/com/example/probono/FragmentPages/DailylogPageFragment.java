...
public class DailylogPageFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        dialogSeniorName = (TextView)view.findViewById(R.id.prevDialSeniorName);
        ...
        dialogRepairButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View item) {
                ...
                if(date != null){
                    ...
                    TextView dialSeName = customDialog.findViewById(R.id.dialogSeniorName);
                    TextView dialNo = customDialog.findViewById(R.id.dialogNo);
                    ...
                    dialSeName.setText(dialogSeniorName.getText().toString());
                    dialNo.setText(dialogNo.getText().toString());
                }
            }
        });
    ...
    class showContent extends JsonNetworkTask<DialogData>{
        ...
        public void postTask(DialogData dialogData) {
            ...
            dialogSeniorName.setText(dialogData.getSeniorName());
        }
    }
    ...
    class PositiveListener implements View.OnClickListener{
        ...
        public void onClick(View item) {
            ...
            saveData.setSeniorName(((TextView)customDialog.findViewById(R.id.dialogSeniorName)).getText().toString());
            calendar.removeDecorator(dayListDecorator);
            ...
            try {
                cv.put("title", saveData.getTitle());
                cv.put("seniorName", saveData.getSeniorName());
